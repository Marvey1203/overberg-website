...
const About = () => {
    return ( 
        ...
        <section className="grid lg:grid-cols-2 grid-cols-1 gap-8 lg:py-[150px] pt-[150px] pb-[100px]">
            ...
            <div>
                <Image className="rounded-[30px]" src={'/Electrician hero about image.jfif'} alt=' animate electrician with icons of tools and electrical items' width={616} height={640} />
            </div>
        </section>
        <section>
            <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-8 gap-4">
                <div>
                    ...
                    <h2 className="lg:text-[45px] text-[28px] leading-tight font-bold">Illuminating Swellendam: Overberg Lighting's Journey</h2>
                </div>
        ...
        <section className="grid lg:grid-cols-2 lg:gap-8 gap-4 lg:py-[150px] py-[50px]">
            <div className="flex flex-col justify-center">
                <h3 className="lg:text-[48px] text-[26px] leading-tight font-bold">"They are by far the best electrician in this town."</h3>
